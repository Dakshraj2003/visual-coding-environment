...
const Sprite = ({ position, rotation, size, visible, selected, image }) => {
  return (
    <div
      className={`relative w-full h-72 bg-white border-2 border-dashed border-gray-400 rounded-lg ${
        selected ? "bg-blue-100" : ""
      }`}
      style={{
        marginRight: "20px", // Space between sprites
      }}
    >
      <img
        src={image}
...
// const Sprite = ({ position, rotation, size, visible, selected }) => {
//   return (
//     <img
//       src={Picture1}
//       alt="Sprite"
